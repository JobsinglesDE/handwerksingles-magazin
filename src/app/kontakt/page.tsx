...
export const metadata: Metadata = {
  ...
  title: 'Kontakt',
  description:
    'Kontakt zum Handwerksingles Magazin: Redaktion, Hinweise zu Artikeln, Pressekontakt, Werbung. Wir antworten innerhalb von 48 Stunden.',
  openGraph: {
    title: 'Kontakt — Handwerksingles Magazin',
    description: 'Kontakt zum Handwerksingles Magazin: Redaktion, Hinweise zu Artikeln, Pressekontakt und Werbung.',
    url: 'https://handwerksingles.de/magazin/kontakt',
    type: 'website',
  ...
  return (
    <section className="max-w-3xl mx-auto px-6 pt-24 pb-20">
      <h1 className="text-4xl md:text-5xl font-bold text-foreground tracking-tight mb-4">
        Kontakt zum Handwerksingles Magazin
      </h1>
      ...
      <section className="space-y-8">
        <div className="rounded-2xl border border-foreground/10 p-6 bg-foreground/5">
          ...
          <p className="text-foreground/70">
            E-Mail:{' '}
            <a
              href="mailto:redaktion@handwerksingles.de"
              className="text-brand-orange hover:underline"
            >
              redaktion@handwerksingles.de
            </a>
          </p>
        ...
        <div className="rounded-2xl border border-foreground/10 p-6 bg-foreground/5">
          <h2 className="text-xl font-bold mb-2">Plattform Handwerksingles.de</h2>
          ...
          <ul className="text-foreground/70 space-y-1">
            <li>
              →{' '}
              <a href="https://handwerksingles.de/hilfe/" className="text-brand-orange hover:underline">
                Hilfe &amp; Support
              </a>
            </li>
            <li>
              →{' '}
              <a href="https://handwerksingles.de/datenschutz.html" className="text-brand-orange hover:underline">
                Datenschutz / Cookies
              </a>
            </li>
            <li>
              →{' '}
              <a href="https://handwerksingles.de/impressum.html" className="text-brand-orange hover:underline">
                Impressum &amp; AGB
              </a>
            </li>
          </ul>
        ...
        <div className="rounded-2xl border border-foreground/10 p-6 bg-foreground/5">
          ...
          <p className="text-foreground/70">
            ...
            <a href="mailto:redaktion@handwerksingles.de" className="text-brand-orange hover:underline">
              redaktion@handwerksingles.de
            </a>
          </p>
        </div>
      ...
      <p className="text-foreground/70">
        Das Handwerksingles Magazin gehört zum Jobsingles-Netzwerk und wird redaktionell von Tommy Honold geführt. Schwerpunkt:
        Partnersuche für Elektriker, Dachdecker, Tischler, Zimmermann und Maurer in der DACH-Region. Die Themen reichen von
        Dating-Tipps bei Montage und Frühschicht über psychologische Aspekte der Partnersuche bis zu Erfolgsgeschichten echter Paare,
        die sich über die Plattform gefunden haben.
      </p>

      <h2 className="text-2xl font-bold mt-10 mb-3">Themenvorschläge willkommen</h2>
      <p className="text-foreground/70">
        Wir nehmen Themen-Vorschläge gerne entgegen — vor allem wenn sie aus erster Hand kommen: aus dem Handwerks-Alltag,
        von der Montage, aus dem Beziehungsalltag mit Frühschicht und Familienbetrieb. Anonymität ist möglich, alle Geschichten werden
