...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }) {
  ...
  if (!author) return {};
  return {
    title: `${author.name} — Autor | Handwerksingles Magazin`,
    description: author.bio || `Artikel von ${author.name} auf dem Handwerksingles Magazin.`,
...
export default async function AuthorPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const personJsonLd = {
    ...
    '@type': 'Person',
    name: author.name,
    url: `https://handwerksingles.de/magazin/autor/${slug}`,
    image: author.avatar
      ? `https://handwerksingles.de/magazin${author.avatar}`
      : undefined,
