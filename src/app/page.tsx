  ...
  return (
    <>
      <section className="relative overflow-hidden min-h-[420px] md:min-h-[560px]">
        <div className="absolute inset-0">
          <Image
            ...
            alt="Handwerksingles — Elektriker, Dachdecker, Tischler und Handwerker-Singles"
            width={1920}
            height={1080}
      ...
      <ScrollReveal>
        <PillarHero
          as="h2"
          title="Handwerksingles"
          texts={[
            "Echte Liebe im Handwerk",
            "Montage trifft Herz",
            "Werkzeug sucht Match",
            "Baustelle & Liebe",
            "Handwerk verbindet",
            "Gewerk trifft Beziehung",
            "Handwerksingles",
          ]}
        />
      </ScrollReveal>
      ...
      <ScrollReveal>
        <section className="max-w-4xl mx-auto px-6 py-12">
          <AnimatedStats
            items={[
              { value: 25000, suffix: '+', label: 'Singles im Handwerk' },
              { value: 53, suffix: '', label: 'Handwerkskammern deutschlandweit' },
              { value: 5400000, suffix: '+', label: 'Handwerker in Deutschland' },
            ]}
          />
        </section>
      </ScrollReveal>
      ...
      <ScrollReveal>
        <section className="text-center py-12 px-6">
          ...
          <p className="text-foreground/60 mb-8 max-w-lg mx-auto">
            Singles im Handwerk — Elektriker, Dachdecker, Tischler, Zimmermann und Maurer — warten auf dich.
          </p>
