...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  const url = `https://handwerksingles.de/magazin/erfolgsgeschichten/${slug}`;
  return {
    title,
    description,
    ...
    <>
      <JsonLd
        data={articleJsonLd({
          ...
          url: `https://handwerksingles.de/magazin/erfolgsgeschichten/${slug}`,
          ...
          <div className="flex justify-center mb-12">
            <PolaroidCard rotation="slight" tape="center">
              <img
                ...
                alt={story.featuredImageAlt || `${story.couple} — Erfolgsgeschichte handwerksingles.de`}
