...
export const metadata = {
  ...
  title: 'Erfolgsgeschichten aus dem Handwerk',
  description: 'Echte Liebesgeschichten von Handwerksingles.de: Elektriker, Dachdecker und Tischler, die ihren Partner im Handwerk gefunden haben.',
  openGraph: {
    title: 'Erfolgsgeschichten — Liebespaare aus dem Handwerk',
    description: 'Echte Liebesgeschichten von Handwerksingles.de: Handwerker-Singles, die die große Liebe gefunden haben.',
    url: 'https://handwerksingles.de/magazin/erfolgsgeschichten',
    ...
    <>
      <section className="relative overflow-hidden py-20 md:py-32">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-lg md:text-xl text-foreground/60 max-w-2xl mx-auto leading-relaxed">
            Echte Paare. Echte Geschichten. So findet das Handwerk die Liebe.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-3xl mx-auto px-6 pb-4">
        <div className="space-y-4 text-foreground/75 leading-relaxed">
          <p>
            Echte Paare, die sich über Handwerksingles.de gefunden haben. Keine Werbesprüche, keine inszenierten Models —
            sondern Menschen, die im Berufsalltag mit Frühschicht, Montage und Familienbetrieb leben. Ihre Geschichten
            zeigen, dass Partnersuche im Handwerk funktioniert, auch wenn die Rahmenbedingungen unvorhersehbar sind.
          </p>
          <p>
