      ...
      <div className="max-w-7xl mx-auto px-6 pt-14 pb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
            ...
            <div>
              <div className="flex items-center gap-3 mb-4">
                <Image
                  ...
                  alt="Handwerksingles Magazin"
                  width={36}
                  height={36}
                  className="rounded-lg"
                />
                <h3 className="font-bold text-lg text-white tracking-tight">
                  <span>Handwerksingles</span><span className="text-white/80"> Magazin</span>
                </h3>
              </div>
              <p className="text-sm text-white/75 leading-relaxed">
                Das Magazin für Elektriker, Dachdecker, Tischler und Handwerker-Singles.
                Partnersuche, Tipps für Montage und Frühschicht und echte Erfolgsgeschichten aus dem Handwerk.
              </p>
            </div>
            ...
            <div>
              ...
              <nav className="flex flex-col gap-2">
                ...
                <Link href="/singles-regional/handwerkskammern" className="text-sm text-white/75 hover:text-white transition-colors">
                  Handwerkskammern
                </Link>
            ...
            <div>
              ...
              <nav className="flex flex-col gap-2">
                <a href="https://handwerksingles.de/hilfe/" className="text-sm text-white/75 hover:text-white transition-colors">
                  Hilfe & Support
                </a>
                <a href="https://handwerksingles.de/kontakt/k%C3%BCndigen/" rel="nofollow" className="text-sm text-white/75 hover:text-white transition-colors">
                  Premium-Mitgliedschaft kündigen
                </a>
                <a href="https://handwerksingles.de/datenschutz.html" className="text-sm text-white/75 hover:text-white transition-colors">
                  Datenschutz
                </a>
                <a href="https://handwerksingles.de/impressum.html" className="text-sm text-white/75 hover:text-white transition-colors">
                  Impressum / AGB
                </a>
        ...
        <div className="mt-8 pt-5 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs text-white/70">
            © {currentYear} Handwerksingles.de — Alle Rechte vorbehalten.
          </p>
          <p className="text-xs text-white/70">
