  ...
  nodes: {
    ...
    link: {
      ...
      transform(node: any, config: any) {
        ...
        // gezielte kontextuelle Cross-Links transferieren Authority im Netz, z.B. Food-Handwerk
        // ↔ Gastronomie). Nur Dritt-Domains werden nofollow, damit Equity nicht verschenkt wird.
        const isExternal = /^https?:\/\//i.test(rawHref) && !/^https?:\/\/(www\.)?handwerksingles\.de/i.test(rawHref);
