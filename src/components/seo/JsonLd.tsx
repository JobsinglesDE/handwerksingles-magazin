...
export function articleJsonLd({
  ...
  return {
    ...
    url,
    ...(image && {
      image: image.startsWith('http') ? [image] : [`https://handwerksingles.de${image.startsWith('/') ? '' : '/'}${image}`],
    }),
    ...
    author: {
      ...
      url: authorUrl || 'https://handwerksingles.de/magazin/autor/tommy-honold',
      sameAs: [
...
/** Occupation/Salary-Schema (Median + Quartile je Fachrichtung) für Gehalt-Hubs (Google-Salary-Signal). */
...
export function organizationJsonLd({
  ...
  if (memberOfBjae) memberOf.push({
    '@type': 'Organization',
    name: 'Zentralverband des Deutschen Handwerks (ZDH)',
